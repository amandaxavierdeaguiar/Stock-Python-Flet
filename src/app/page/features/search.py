...
from app.app_style import button
...
class Search(SharedControls):
    ...
    def button_insert(cls, var, table):
        if table == 'Stock':
            return ft.ElevatedButton(text='Insert Product', **button(), on_click=var, data='Stock_insert')
        elif table == 'Supplier':
            return ft.ElevatedButton(text='Insert Supplier', **button(), on_click=var, data='Supplier_insert')
        elif table == 'User':
            return ft.ElevatedButton(text='Insert User', **button(), on_click=var, data='User_insert')
